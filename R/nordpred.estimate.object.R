...
#' Objects of this class have methods \code{\link{print.nordpred.estimate}}, 
...
#' If \code{recent = FALSE}, recommendation is to use average trend for the whole observation 
#' period, and if \code{recent = TRUE} recommendation is to use the slope from the last 10 years}
