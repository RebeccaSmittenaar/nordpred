...
#' 
#' @return an object of class \code{\link{nordpred.prediction}}.
#' 
#' @references 
#' \itemize{
...
#' res2 <- nordpred.prediction(est2,startuseage=6,cuttrend=c(0,.25,.5,.75,.75),rec ent=T)
#' 
#' # Get results: 
#' print.nordpred(res) 
